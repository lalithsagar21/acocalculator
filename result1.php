         ...
         <div class="container">
            <div class="row ">
                <div class="col-md-12 text-center">
                    <h2 class="font-adj"><strong>Questions to Help Guide ACO Comparison</strong></h2>
                </div>
                <div class="col-md-6 color-a font-base pt-3">
                <ul>
	<li class="rlt_li"><span>What is your track record for success historically?</span></li>
	<li class="rlt_li"><span>How involved are providers in input and decision-making when it comes to the ACO?</span></li>
	<li class="rlt_li"><span>What are the ACO infrastructure costs and redesign expenses?</span></li>
	<li class="rlt_li"><span>When does your ACO distribute savings?</span></li>
</ul>
               </div>
               <div class="col-md-6 color-a font-base pt-3">
               <ul>
                   <li class="rlt_li"><span>What track have you selected and how have you accounted for attribution, risk adjustment, and benchmark considerations?</span></li>
                   <li class="rlt_li"><span>What year do you project you will participate in downside risk?</span></li>
                   <li class="rlt_li"><span>How is your ACO preparing for downside risk?</span></li>
                   <li class="rlt_li"><span>How is your ACO mitigating risk in downside arrangements?</span></li>
                </ul>
               </div>
            </div>
         </div>
